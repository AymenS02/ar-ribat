...
const AboutUs = () => {
  ...
  useEffect(() => {
    ...
    // Set initial states
    window.gsap.set([titleRef.current, missionTextRef.current, logoRef.current], {
      opacity: 0,
      y: 50
    });
    
    window.gsap.set(decorativeElementsRef.current, {
      scale: 0,
      rotation: 45
    });
    ...
    // Animate mission text with stagger effect for each word
